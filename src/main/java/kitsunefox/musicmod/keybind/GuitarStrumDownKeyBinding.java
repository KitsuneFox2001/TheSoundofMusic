...
import kitsunefox.musicmod.procedures.GuitarStrumDownKeyPressProcedure;
...
public class GuitarStrumDownKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public GuitarStrumDownKeyBinding(MusicmodModElements instance) {
		super(instance, 107);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.guitar_strum_down", GLFW.GLFW_KEY_DOWN, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			GuitarStrumDownKeyPressProcedure.executeProcedure(Stream
