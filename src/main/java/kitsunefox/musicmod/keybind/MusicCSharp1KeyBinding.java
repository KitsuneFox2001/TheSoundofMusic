...
import kitsunefox.musicmod.procedures.MusicCSharp1OnKeyPressedProcedure;
...
public class MusicCSharp1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicCSharp1KeyBinding(MusicmodModElements instance) {
		super(instance, 63);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_c_sharp_1", GLFW.GLFW_KEY_S, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicCSharp1OnKeyPressedProcedure.executeProcedure(Stream
