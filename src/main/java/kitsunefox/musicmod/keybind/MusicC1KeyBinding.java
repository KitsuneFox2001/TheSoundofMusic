...
import kitsunefox.musicmod.procedures.MusicC1OnKeyPressedProcedure;
...
public class MusicC1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicC1KeyBinding(MusicmodModElements instance) {
		super(instance, 61);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_c_1", GLFW.GLFW_KEY_Z, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicC1OnKeyPressedProcedure.executeProcedure(Stream
