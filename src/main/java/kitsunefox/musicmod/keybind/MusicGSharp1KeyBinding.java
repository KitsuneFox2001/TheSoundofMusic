...
import kitsunefox.musicmod.procedures.MusicGSharp1KeyPressedProcedure;
...
public class MusicGSharp1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicGSharp1KeyBinding(MusicmodModElements instance) {
		super(instance, 83);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_g_sharp_1", GLFW.GLFW_KEY_H, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicGSharp1KeyPressedProcedure.executeProcedure(Stream
