...
import kitsunefox.musicmod.procedures.MusicDOnKeyPressedProcedure;
...
public class MusicD1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicD1KeyBinding(MusicmodModElements instance) {
		super(instance, 65);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_d_1", GLFW.GLFW_KEY_X, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicDOnKeyPressedProcedure.executeProcedure(Stream
