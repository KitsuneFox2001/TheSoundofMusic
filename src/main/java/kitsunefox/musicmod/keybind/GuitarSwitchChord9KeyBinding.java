...
import kitsunefox.musicmod.procedures.GuitarSwitchChord9OnKeyPressedProcedure;
...
public class GuitarSwitchChord9KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public GuitarSwitchChord9KeyBinding(MusicmodModElements instance) {
		super(instance, 118);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.guitar_switch_chord_9", GLFW.GLFW_KEY_PERIOD, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			GuitarSwitchChord9OnKeyPressedProcedure.executeProcedure(Stream
