...
import kitsunefox.musicmod.procedures.GuitarSwitchChord7OnKeyPressedProcedure;
...
public class GuitarSwitchChord7KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public GuitarSwitchChord7KeyBinding(MusicmodModElements instance) {
		super(instance, 115);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.guitar_switch_chord_7", GLFW.GLFW_KEY_M, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			GuitarSwitchChord7OnKeyPressedProcedure.executeProcedure(Stream
