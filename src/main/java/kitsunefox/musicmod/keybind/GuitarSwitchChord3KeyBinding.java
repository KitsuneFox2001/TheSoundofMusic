...
import kitsunefox.musicmod.procedures.GuitarSwitchChord3OnKeyPressedProcedure;
...
public class GuitarSwitchChord3KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public GuitarSwitchChord3KeyBinding(MusicmodModElements instance) {
		super(instance, 111);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.guitar_switch_chord_3", GLFW.GLFW_KEY_C, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			GuitarSwitchChord3OnKeyPressedProcedure.executeProcedure(Stream
