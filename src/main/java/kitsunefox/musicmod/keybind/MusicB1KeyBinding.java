...
import kitsunefox.musicmod.procedures.MusicB1KeyPressedProcedure;
...
public class MusicB1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicB1KeyBinding(MusicmodModElements instance) {
		super(instance, 89);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_b_1", GLFW.GLFW_KEY_M, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicB1KeyPressedProcedure.executeProcedure(Stream
