...
import kitsunefox.musicmod.procedures.GuitarSwitchChord5OnKeyPressedProcedure;
...
public class GuitarSwitchChord5KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public GuitarSwitchChord5KeyBinding(MusicmodModElements instance) {
		super(instance, 113);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.guitar_switch_chord_5", GLFW.GLFW_KEY_B, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			GuitarSwitchChord5OnKeyPressedProcedure.executeProcedure(Stream
