...
import kitsunefox.musicmod.procedures.DrumsXKeyPressedProcedure;
...
public class DrumsXKeyKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DrumsXKeyKeyBinding(MusicmodModElements instance) {
		super(instance, 207);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.drums_x_key", GLFW.GLFW_KEY_X, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DrumsXKeyPressedProcedure.executeProcedure(Stream
