...
import kitsunefox.musicmod.procedures.MusicCSharp2KeyPressedProcedure;
...
public class MusicCSharp2KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicCSharp2KeyBinding(MusicmodModElements instance) {
		super(instance, 93);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_c_sharp_2", GLFW.GLFW_KEY_L, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicCSharp2KeyPressedProcedure.executeProcedure(Stream
