...
import kitsunefox.musicmod.procedures.DrumsVKeyPressedProcedure;
...
public class DrumsVKeyKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DrumsVKeyKeyBinding(MusicmodModElements instance) {
		super(instance, 209);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.drums_v_key", GLFW.GLFW_KEY_V, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DrumsVKeyPressedProcedure.executeProcedure(Stream
