...
import kitsunefox.musicmod.procedures.MusicE2KeyPressedProcedure;
...
public class MusicE2KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicE2KeyBinding(MusicmodModElements instance) {
		super(instance, 99);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_e_2", GLFW.GLFW_KEY_SLASH, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicE2KeyPressedProcedure.executeProcedure(Stream
