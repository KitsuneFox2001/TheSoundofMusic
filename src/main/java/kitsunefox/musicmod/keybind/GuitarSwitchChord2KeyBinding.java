...
import kitsunefox.musicmod.procedures.GuitarSwitchChord2OnKeyPressedProcedure;
...
public class GuitarSwitchChord2KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public GuitarSwitchChord2KeyBinding(MusicmodModElements instance) {
		super(instance, 110);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.guitar_switch_chord_2", GLFW.GLFW_KEY_X, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			GuitarSwitchChord2OnKeyPressedProcedure.executeProcedure(Stream
