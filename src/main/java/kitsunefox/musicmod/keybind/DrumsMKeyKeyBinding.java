...
import kitsunefox.musicmod.procedures.DrumsMKeyPressedProcedure;
...
public class DrumsMKeyKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DrumsMKeyKeyBinding(MusicmodModElements instance) {
		super(instance, 212);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.drums_m_key", GLFW.GLFW_KEY_M, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DrumsMKeyPressedProcedure.executeProcedure(Stream
