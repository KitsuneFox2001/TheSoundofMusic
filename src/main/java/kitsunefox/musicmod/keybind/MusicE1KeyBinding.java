...
import kitsunefox.musicmod.procedures.MusicEOnKeyPressedProcedure;
...
public class MusicE1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicE1KeyBinding(MusicmodModElements instance) {
		super(instance, 75);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_e_1", GLFW.GLFW_KEY_C, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicEOnKeyPressedProcedure.executeProcedure(Stream
