...
import kitsunefox.musicmod.procedures.MusicC2KeyPressedProcedure;
...
public class MusicC2KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicC2KeyBinding(MusicmodModElements instance) {
		super(instance, 91);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_c_2", GLFW.GLFW_KEY_KP_DECIMAL, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicC2KeyPressedProcedure.executeProcedure(Stream
