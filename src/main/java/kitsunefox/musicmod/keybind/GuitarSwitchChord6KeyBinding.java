...
import kitsunefox.musicmod.procedures.GuitarSwitchChord6OnKeyPressedProcedure;
...
public class GuitarSwitchChord6KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public GuitarSwitchChord6KeyBinding(MusicmodModElements instance) {
		super(instance, 114);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.guitar_switch_chord_6", GLFW.GLFW_KEY_N, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			GuitarSwitchChord6OnKeyPressedProcedure.executeProcedure(Stream
