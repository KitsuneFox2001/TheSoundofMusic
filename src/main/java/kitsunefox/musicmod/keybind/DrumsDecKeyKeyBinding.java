...
import kitsunefox.musicmod.procedures.DrumsDecKeyPressedProcedure;
...
public class DrumsDecKeyKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DrumsDecKeyKeyBinding(MusicmodModElements instance) {
		super(instance, 214);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.drums_dec_key", GLFW.GLFW_KEY_KP_DECIMAL, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DrumsDecKeyPressedProcedure.executeProcedure(Stream
