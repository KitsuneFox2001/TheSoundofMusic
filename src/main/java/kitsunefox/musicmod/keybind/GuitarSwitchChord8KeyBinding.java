...
import kitsunefox.musicmod.procedures.GuitarSwitchChord8OnKeyPressedProcedure;
...
public class GuitarSwitchChord8KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public GuitarSwitchChord8KeyBinding(MusicmodModElements instance) {
		super(instance, 116);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.guitar_switch_chord_8", GLFW.GLFW_KEY_KP_DECIMAL, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			GuitarSwitchChord8OnKeyPressedProcedure.executeProcedure(Stream
