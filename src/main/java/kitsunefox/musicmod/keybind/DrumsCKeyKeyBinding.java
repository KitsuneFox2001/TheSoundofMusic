...
import kitsunefox.musicmod.procedures.DrumsCKeyPressedProcedure;
...
public class DrumsCKeyKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DrumsCKeyKeyBinding(MusicmodModElements instance) {
		super(instance, 208);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.drums_c_key", GLFW.GLFW_KEY_C, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DrumsCKeyPressedProcedure.executeProcedure(Stream
