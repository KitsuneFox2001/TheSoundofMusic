...
import kitsunefox.musicmod.procedures.MusicFOnKeyPressedProcedure;
...
public class MusicF1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicF1KeyBinding(MusicmodModElements instance) {
		super(instance, 77);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_f_1", GLFW.GLFW_KEY_V, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicFOnKeyPressedProcedure.executeProcedure(Stream
