...
import kitsunefox.musicmod.procedures.MusicDSharpOnKeyPressedProcedure;
...
public class MusicDSharp1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicDSharp1KeyBinding(MusicmodModElements instance) {
		super(instance, 73);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_d_sharp_1", GLFW.GLFW_KEY_D, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicDSharpOnKeyPressedProcedure.executeProcedure(Stream
