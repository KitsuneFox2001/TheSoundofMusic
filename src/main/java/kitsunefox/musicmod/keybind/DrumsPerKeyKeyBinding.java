...
import kitsunefox.musicmod.procedures.DrumsPerKeyPressedProcedure;
...
public class DrumsPerKeyKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DrumsPerKeyKeyBinding(MusicmodModElements instance) {
		super(instance, 213);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.drums_per_key", GLFW.GLFW_KEY_PERIOD, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DrumsPerKeyPressedProcedure.executeProcedure(Stream
