...
import kitsunefox.musicmod.procedures.PianoSwitchOctavesDownOnKeyPressedProcedure;
...
public class PianoSwitchOctavesDownKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public PianoSwitchOctavesDownKeyBinding(MusicmodModElements instance) {
		super(instance, 71);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.piano_switch_octaves_down", GLFW.GLFW_KEY_DOWN, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			PianoSwitchOctavesDownOnKeyPressedProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
