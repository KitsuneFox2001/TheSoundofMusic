...
import kitsunefox.musicmod.procedures.MusicASharp1KeyPressedProcedure;
...
public class MusicASharp1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicASharp1KeyBinding(MusicmodModElements instance) {
		super(instance, 87);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_a_sharp_1", GLFW.GLFW_KEY_J, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicASharp1KeyPressedProcedure.executeProcedure(Stream
