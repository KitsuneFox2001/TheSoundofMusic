...
import kitsunefox.musicmod.procedures.MusicD2KeyPressedProcedure;
...
public class MusicD2KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicD2KeyBinding(MusicmodModElements instance) {
		super(instance, 95);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_d_2", GLFW.GLFW_KEY_PERIOD, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicD2KeyPressedProcedure.executeProcedure(Stream
