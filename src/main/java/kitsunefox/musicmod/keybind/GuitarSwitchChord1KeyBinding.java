...
import kitsunefox.musicmod.procedures.GuitarSwitchChord1OnKeyPressedProcedure;
...
public class GuitarSwitchChord1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public GuitarSwitchChord1KeyBinding(MusicmodModElements instance) {
		super(instance, 103);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.guitar_switch_chord_1", GLFW.GLFW_KEY_Z, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			GuitarSwitchChord1OnKeyPressedProcedure.executeProcedure(Stream
