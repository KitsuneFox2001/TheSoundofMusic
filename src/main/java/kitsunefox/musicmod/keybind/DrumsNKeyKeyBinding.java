...
import kitsunefox.musicmod.procedures.DrumsNKeyPressedProcedure;
...
public class DrumsNKeyKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DrumsNKeyKeyBinding(MusicmodModElements instance) {
		super(instance, 211);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.drums_n_key", GLFW.GLFW_KEY_N, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DrumsNKeyPressedProcedure.executeProcedure(Stream
