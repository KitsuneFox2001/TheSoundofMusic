...
import kitsunefox.musicmod.procedures.MusicFSharpOnKeyPressedProcedure;
...
public class MusicFSharp1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicFSharp1KeyBinding(MusicmodModElements instance) {
		super(instance, 79);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_f_sharp_1", GLFW.GLFW_KEY_G, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicFSharpOnKeyPressedProcedure.executeProcedure(Stream
