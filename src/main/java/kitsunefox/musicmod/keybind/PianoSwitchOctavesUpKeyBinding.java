...
import kitsunefox.musicmod.procedures.PianoSwitchOctavesUpOnKeyPressedProcedure;
...
public class PianoSwitchOctavesUpKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public PianoSwitchOctavesUpKeyBinding(MusicmodModElements instance) {
		super(instance, 70);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.piano_switch_octaves_up", GLFW.GLFW_KEY_UP, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			PianoSwitchOctavesUpOnKeyPressedProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
