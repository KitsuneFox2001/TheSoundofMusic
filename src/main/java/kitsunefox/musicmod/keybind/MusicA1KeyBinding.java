...
import kitsunefox.musicmod.procedures.MusicA1KeyPressedProcedure;
...
public class MusicA1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicA1KeyBinding(MusicmodModElements instance) {
		super(instance, 85);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_a_1", GLFW.GLFW_KEY_N, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicA1KeyPressedProcedure.executeProcedure(Stream
