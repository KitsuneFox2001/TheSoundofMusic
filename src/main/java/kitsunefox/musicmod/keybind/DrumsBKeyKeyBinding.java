...
import kitsunefox.musicmod.procedures.DrumsBKeyPressedProcedure;
...
public class DrumsBKeyKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DrumsBKeyKeyBinding(MusicmodModElements instance) {
		super(instance, 210);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.drums_b_key", GLFW.GLFW_KEY_B, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DrumsBKeyPressedProcedure.executeProcedure(Stream
