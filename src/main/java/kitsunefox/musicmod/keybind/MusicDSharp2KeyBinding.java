...
import kitsunefox.musicmod.procedures.MusicDSharp2KeyPressedProcedure;
...
public class MusicDSharp2KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicDSharp2KeyBinding(MusicmodModElements instance) {
		super(instance, 97);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_d_sharp_2", GLFW.GLFW_KEY_KP_DECIMAL, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicDSharp2KeyPressedProcedure.executeProcedure(Stream
