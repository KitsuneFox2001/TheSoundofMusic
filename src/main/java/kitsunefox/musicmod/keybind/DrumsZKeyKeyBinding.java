...
import kitsunefox.musicmod.procedures.DrumsZKeyPressedProcedure;
...
public class DrumsZKeyKeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DrumsZKeyKeyBinding(MusicmodModElements instance) {
		super(instance, 206);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.drums_z_key", GLFW.GLFW_KEY_Z, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			DrumsZKeyPressedProcedure.executeProcedure(Stream
