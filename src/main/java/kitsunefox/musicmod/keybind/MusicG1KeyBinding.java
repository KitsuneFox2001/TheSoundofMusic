...
import kitsunefox.musicmod.procedures.MusicGOnKeyPressedProcedure;
...
public class MusicG1KeyBinding extends MusicmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MusicG1KeyBinding(MusicmodModElements instance) {
		super(instance, 81);
	...
	public void initElements() {
		keys = new KeyBinding("key.musicmod.music_g_1", GLFW.GLFW_KEY_B, "key.categories.music");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MusicGOnKeyPressedProcedure.executeProcedure(Stream
