...
import kitsunefox.musicmod.procedures.ModGuideBookPlaySoundProcedure;
import kitsunefox.musicmod.itemgroup.MusicItemGroup;
import kitsunefox.musicmod.gui.ModGuideBook12GuiWindow;
...
public class ModGuideBookItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:mod_guide_book")
	public static final Item block = null;

	public ModGuideBookItem(MusicmodModElements instance) {
		super(instance, 1);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof ModGuideBook12GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(MusicItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("mod_guide_book");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A book by KitsuneFox"));
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("A Guide to The Sound of Music");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new ModGuideBook12Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
			...
			ModGuideBookPlaySoundProcedure.executeProcedure(Stream
