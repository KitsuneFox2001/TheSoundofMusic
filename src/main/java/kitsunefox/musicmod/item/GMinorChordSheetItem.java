...
public class GMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:g_minor_chord_sheet")
	public static final Item block = null;

	public GMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 39);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("g_minor_chord_sheet");
		}
