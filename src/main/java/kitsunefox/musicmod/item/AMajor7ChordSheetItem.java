...
public class AMajor7ChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:a_major_7_chord_sheet")
	public static final Item block = null;

	public AMajor7ChordSheetItem(MusicmodModElements instance) {
		super(instance, 53);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("a_major_7_chord_sheet");
		}
