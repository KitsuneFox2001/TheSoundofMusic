...
public class CSharpMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:c_sharp_minor_chord_sheet")
	public static final Item block = null;

	public CSharpMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 33);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("c_sharp_minor_chord_sheet");
		}
