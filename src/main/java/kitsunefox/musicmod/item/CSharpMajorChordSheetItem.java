...
public class CSharpMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:c_sharp_major_chord_sheet")
	public static final Item block = null;

	public CSharpMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 21);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("c_sharp_major_chord_sheet");
		}
