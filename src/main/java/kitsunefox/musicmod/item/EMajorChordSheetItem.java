...
public class EMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:e_major_chord_sheet")
	public static final Item block = null;

	public EMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 24);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("e_major_chord_sheet");
		}
