...
public class BMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:b_minor_chord_sheet")
	public static final Item block = null;

	public BMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 43);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("b_minor_chord_sheet");
		}
