...
public class CMajor7ChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:c_major_7_chord_sheet")
	public static final Item block = null;

	public CMajor7ChordSheetItem(MusicmodModElements instance) {
		super(instance, 44);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("c_major_7_chord_sheet");
		}
