...
public class DMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:d_minor_chord_sheet")
	public static final Item block = null;

	public DMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 34);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("d_minor_chord_sheet");
		}
