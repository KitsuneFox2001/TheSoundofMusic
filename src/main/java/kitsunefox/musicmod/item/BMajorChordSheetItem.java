...
public class BMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:b_major_chord_sheet")
	public static final Item block = null;

	public BMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 31);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("b_major_chord_sheet");
		}
