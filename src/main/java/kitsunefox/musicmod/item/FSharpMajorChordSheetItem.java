...
public class FSharpMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:f_sharp_major_chord_sheet")
	public static final Item block = null;

	public FSharpMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 26);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("f_sharp_major_chord_sheet");
		}
