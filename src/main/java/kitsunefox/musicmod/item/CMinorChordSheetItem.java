...
public class CMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:c_minor_chord_sheet")
	public static final Item block = null;

	public CMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 32);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("c_minor_chord_sheet");
		}
