...
public class CSharpMajor7ChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:c_sharp_major_7_chord_sheet")
	public static final Item block = null;

	public CSharpMajor7ChordSheetItem(MusicmodModElements instance) {
		super(instance, 45);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("c_sharp_major_7_chord_sheet");
		}
