...
public class ASharpMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:a_sharp_minor_chord_sheet")
	public static final Item block = null;

	public ASharpMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 42);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("a_sharp_minor_chord_sheet");
		}
