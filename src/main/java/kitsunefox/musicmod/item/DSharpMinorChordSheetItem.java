...
public class DSharpMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:d_sharp_minor_chord_sheet")
	public static final Item block = null;

	public DSharpMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 35);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("d_sharp_minor_chord_sheet");
		}
