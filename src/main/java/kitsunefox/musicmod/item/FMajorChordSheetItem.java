...
public class FMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:f_major_chord_sheet")
	public static final Item block = null;

	public FMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 25);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("f_major_chord_sheet");
		}
