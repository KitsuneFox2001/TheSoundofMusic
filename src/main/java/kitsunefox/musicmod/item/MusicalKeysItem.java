...
public class MusicalKeysItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:musical_keys")
	public static final Item block = null;

	public MusicalKeysItem(MusicmodModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Use those to craft pianos!"));
		}
	}
}
