...
public class FSharpMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:f_sharp_minor_chord_sheet")
	public static final Item block = null;

	public FSharpMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 38);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("f_sharp_minor_chord_sheet");
		}
