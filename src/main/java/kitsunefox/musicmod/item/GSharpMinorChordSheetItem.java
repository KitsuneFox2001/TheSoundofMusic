...
public class GSharpMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:g_sharp_minor_chord_sheet")
	public static final Item block = null;

	public GSharpMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 40);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("g_sharp_minor_chord_sheet");
		}
