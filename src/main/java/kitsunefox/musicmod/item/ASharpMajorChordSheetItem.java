...
public class ASharpMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:a_sharp_major_chord_sheet")
	public static final Item block = null;

	public ASharpMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 30);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("a_sharp_major_chord_sheet");
		}
