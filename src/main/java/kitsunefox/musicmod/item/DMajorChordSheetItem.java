...
public class DMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:d_major_chord_sheet")
	public static final Item block = null;

	public DMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 22);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("d_major_chord_sheet");
		}
