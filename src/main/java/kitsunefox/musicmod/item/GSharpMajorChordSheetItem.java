...
public class GSharpMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:g_sharp_major_chord_sheet")
	public static final Item block = null;

	public GSharpMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 28);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("g_sharp_major_chord_sheet");
		}
