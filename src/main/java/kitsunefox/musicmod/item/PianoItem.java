...
public class PianoItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:piano")
	public static final Item block = null;

	public PianoItem(MusicmodModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Play beautiful melodies with your piano!"));
		}
