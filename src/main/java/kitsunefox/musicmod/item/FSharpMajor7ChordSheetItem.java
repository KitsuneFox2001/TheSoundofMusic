...
public class FSharpMajor7ChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:f_sharp_major_7_chord_sheet")
	public static final Item block = null;

	public FSharpMajor7ChordSheetItem(MusicmodModElements instance) {
		super(instance, 50);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("f_sharp_major_7_chord_sheet");
		}
