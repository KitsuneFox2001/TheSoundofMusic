...
public class DMajorSharp7ChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:d_major_sharp_7_chord_sheet")
	public static final Item block = null;

	public DMajorSharp7ChordSheetItem(MusicmodModElements instance) {
		super(instance, 47);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("d_major_sharp_7_chord_sheet");
		}
