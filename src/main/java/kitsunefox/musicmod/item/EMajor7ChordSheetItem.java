...
public class EMajor7ChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:e_major_7_chord_sheet")
	public static final Item block = null;

	public EMajor7ChordSheetItem(MusicmodModElements instance) {
		super(instance, 48);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("e_major_7_chord_sheet");
		}
