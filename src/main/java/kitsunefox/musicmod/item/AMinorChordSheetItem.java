...
public class AMinorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:a_minor_chord_sheet")
	public static final Item block = null;

	public AMinorChordSheetItem(MusicmodModElements instance) {
		super(instance, 41);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("a_minor_chord_sheet");
		}
