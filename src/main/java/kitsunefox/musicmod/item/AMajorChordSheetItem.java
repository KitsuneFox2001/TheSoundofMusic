...
public class AMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:a_major_chord_sheet")
	public static final Item block = null;

	public AMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 29);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("a_major_chord_sheet");
		}
