...
public class GuitarTunerItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:guitar_tuner")
	public static final Item block = null;

	public GuitarTunerItem(MusicmodModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Use to craft a Guitar Head."));
		}
	}
}
