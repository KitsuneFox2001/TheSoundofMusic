...
public class GMajorChordSheetItem extends MusicmodModElements.ModElement {
	@ObjectHolder("musicmod:g_major_chord_sheet")
	public static final Item block = null;

	public GMajorChordSheetItem(MusicmodModElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("g_major_chord_sheet");
		}
